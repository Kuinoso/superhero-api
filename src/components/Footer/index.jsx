        ...
        <div className={classes.container}>
            <div className={classes.row}>
                ...
                <Typography variant="overline" gutterBottom className={classes.text}>
                    Visit <a target='_blank' href='https://github.com/Kuinoso/superhero-api' className={classes.link}>Github page</a> - || - Online API by {<a target="_blank" className={classes.link} href='https://rapidapi.com/jakash1997/api/superhero-search/endpoints'>Superhero-Search API</a>}
                    {<br></br>}
